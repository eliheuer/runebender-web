...
export class GlyphEditor {
     ...
     * @returns {boolean}
     */
    optimizeSelection(tol) {
        const ret = wasm.glypheditor_optimizeSelection(this.__wbg_ptr, tol);
        return ret !== 0;
    }
    /**
     * @returns {boolean}
 ...
 * @param {string} glyphs_text
 * @returns {string}
 */
export function glyphsToUfoFiles(glyphs_text) {
    let deferred3_0;
    let deferred3_1;
    try {
        const ptr0 = passStringToWasm0(glyphs_text, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.glyphsToUfoFiles(ptr0, len0);
        var ptr2 = ret[0];
        var len2 = ret[1];
        if (ret[3]) {
            ptr2 = 0; len2 = 0;
...
function __wbg_get_imports() {
    const import0 = {
        ...
        __wbg_new_typed_c072c4ce9a2a0cdf: function(arg0, arg1) {
            try {
                ...
                var cb0 = (arg0, arg1) => {
                    ...
                    state0.a = 0;
                    try {
                        return wasm_bindgen__convert__closures_____invoke__h71496dd931fb9e82(a, state0.b, arg0, arg1);
                    } finally {
                        state0.a = a;
                    }
                };
        ...
        __wbindgen_cast_0000000000000002: function(arg0, arg1) {
            // Cast intrinsic for `Closure(Closure { owned: true, function: Function { arguments: [Externref], shim_idx: 548, ret: Result(Unit), inner_ret: Some(Result(Unit)) }, mutable: true }) -> Externref`.
...
function wasm_bindgen__convert__closures_____invoke__h6a659fc9c8d6adff(arg0, arg1, arg2) {
    wasm.wasm_bindgen__convert__closures_____invoke__h6a659fc9c8d6adff(arg0, arg1, arg2);
}

function wasm_bindgen__convert__closures_____invoke__h61b71dc7eda4b46f(arg0, arg1, arg2) {
    const ret = wasm.wasm_bindgen__convert__closures_____invoke__h61b71dc7eda4b46f(arg0, arg1, arg2);
    if (ret[1]) {
        throw takeFromExternrefTable0(ret[0]);
    }
}

function wasm_bindgen__convert__closures_____invoke__h71496dd931fb9e82(arg0, arg1, arg2, arg3) {
    wasm.wasm_bindgen__convert__closures_____invoke__h71496dd931fb9e82(arg0, arg1, arg2, arg3);
}
