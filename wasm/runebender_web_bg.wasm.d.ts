...
export const glypheditor_activeTextSortRtl: (a: number) => number;
export const glypheditor_addAnchorAt: (a: number, b: number, c: number, d: number, e: number) => number;
export const glypheditor_addComponent: (a: number, b: number, c: number) => number;
...
export const glypheditor_componentAlignmentState: (a: number) => [number, number];
export const glypheditor_componentBaseAt: (a: number, b: number, c: number) => [number, number];
export const glypheditor_componentCount: (a: number) => number;
...
export const glypheditor_decomposeComponents: (a: number, b: number) => number;
...
export const glypheditor_selectComponentAt: (a: number, b: number, c: number) => number;
...
export const glypheditor_setBackgroundOutline: (a: number, b: number, c: number) => void;
export const glypheditor_setComponentAlignment: (a: number, b: number) => number;
...
export const glypheditor_setReferenceOutline: (a: number, b: number, c: number) => void;
...
export const glypheditor_setTextGlyphMetrics: (a: number, b: number, c: number) => [number, number];
...
export const glypheditor_sidebearingEdgeAt: (a: number, b: number, c: number) => number;
...
export const glypheditor_textBufferPreviewSvg: (a: number, b: number) => [number, number, number, number];
